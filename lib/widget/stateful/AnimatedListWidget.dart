...
class _AnimatedListWidgetState extends State<AnimatedListWidget> {
  ...
  static final List<UserBean> animatedList = [
    UserBean('baby1', 'images/baby1.jpg'),
    UserBean('baby2', 'images/baby2.jpg'),
    UserBean('baby3', 'images/baby3.jpg'),
    UserBean('baby4', 'images/baby4.png'),
    UserBean('stare1', 'images/stare1.jpg'),
    UserBean('stare2', 'images/stare2.jpg'),
  ];
  static final addItem = UserBean('baby1', 'images/baby1.jpg');
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '强化版的ListView,可以对item进行动画处理，如在添加、删除item时的动画。',
                  style: descStyle,
                ),
              ),
              SizedBox(
