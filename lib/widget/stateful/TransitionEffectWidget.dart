          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '可容纳一个子组件，并使其进行旋转动画，需要提供动画器 turns ，拥alignment 属性。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
...
// ⼦组件
              ...
              Container(
                ...
                child: const Text(
                  '可容纳一个子组件，并使其进行旋转动画，需要提供动画器 scale ，拥有alignment 属性。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
              ...
              Container(
                ...
                child: const Text(
                  '可容纳一个子组件，并使其进行旋转动画，，需要提供动画器 sizeFactor，可指定尺⼨变化轴及轴向的 axisAlignment。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
...
// 开始左上，结束右下
              ...
              Container(
                ...
                child: const Text(
                  'AnimatedWidget的子类，使用Offset 类型的动画器让子组件在两个Offset 对象之间进行过渡动画。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
...
// x轴⽅向
              ...
              Container(
                ...
                child: const Text(
                  'AnimatedWidget子类，使用 Decorated 类型的动画器让子组件在两个Decorated 对象之间进行过渡动画。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
