          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '能让子组件进行Opacity(透明度)动画，可指定市场和曲线，有动画结束事件。',
                  style: descStyle,
                ),
              ),
              Switch(
              ...
              Container(
                ...
                child: const Text(
                  '相关属性变化时具有动画效果的PhysicalModel组件，本质是PhysicalMode l和动画结合的产物。可指定阴影、影深、圆角、动画时长、结束回调等厲性。',
                  style: descStyle,
                ),
              ),
              Switch(
...
// 形状
              ...
              Container(
                ...
                child: const Text(
                  '主题变化时具有动画效果的组件，本质是Theme组件和动画结合的产物。可指定ThemeData、动画时长、曲线、结束回调等。相当于增强版的Theme组件。',
                style: descStyle,
                ),
              ),
              Switch(
              ...
              Container(
                ...
                child: const Text(
                  '通过渐变器 Tween 对相关属性进⾏渐变动画，通过 builder 进行局部构建，减少刷新范围。不需要自定义动画器，可指定动画时长、曲线、结朿回调。',
                  style: descStyle,
                ),
              ),
              SizedBox(
